...
export class PortfolioService {
  ...
  getActivePortfolios(): Observable<Portfolio[]> {
    return this.http.get<Portfolio[]>(`${this.apiUrl}/active`).pipe(
      tap(portfolios => console.log('Active portfolio items fetched:', portfolios)),
  ...
  createPortfolio(portfolio: Portfolio): Observable<Portfolio> {
    console.log('=== DEBUG: Creating portfolio item with data ===', portfolio);
    ...
    console.log('Portfolio item data being sent:', portfolioData);
    
    return this.http.post<Portfolio>(this.apiUrl, portfolioData).pipe(
      tap(createdPortfolio => console.log('Portfolio item created:', createdPortfolio)),
      catchError(this.handleError)
    );
  }
  ...
  updatePortfolio(id: number, portfolio: Portfolio): Observable<Portfolio> {
    console.log('=== DEBUG: Updating portfolio item with data ===', portfolio);
    ...
    return this.http.put<Portfolio>(`${this.apiUrl}/${id}`, portfolioData).pipe(
      tap(updatedPortfolio => console.log('Portfolio item updated:', updatedPortfolio)),
      catchError(this.handleError)
    );
  }
